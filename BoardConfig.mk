...
DEVICE_PATH := device/infinix/NoobUsers
...
# Assert
TARGET_OTA_ASSERT_DEVICE := NoobUsers

# Partition
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_BOOTIMAGE_PARTITION_SIZE := 37554432
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 37554432
...
#SHRP_Variables
SHRP_PATH := device/infinix/NoobUsers
SHRP_MAINTAINER := @A-Rehman
SHRP_DEVICE_CODE := NoobUsers
...
SHRP_EXTERNAL_ADDON_1_NAME := "Sign-In Boot"

# Text Message About Addon.
SHRP_EXTERNAL_ADDON_1_INFO := "This Will Sign-In your boot and twrp will not be replace by stock recovery after reboot"

#Name Of Addon.
SHRP_EXTERNAL_ADDON_1_FILENAME := "sign_boot.zip"

# Last Warning About Installtion.
SHRP_EXTERNAL_ADDON_1_BTN_TEXT := "Confirm"

# On Successfull Installtion.
SHRP_EXTERNAL_ADDON_1_SUCCESSFUL_TEXT := "Boot Sign-In Successfully"
